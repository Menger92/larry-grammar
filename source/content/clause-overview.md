...
查阅复杂句时，不要只沿着“从句类型”纵向寻找。先横向判断这个结构在句中承担什么功能，再确认它采用从句、非谓语还是介词短语等表现形式。
...
记忆点：先找主干，再标出结构承担的功能，最后判断表现形式。矩阵负责总览，具体规则和更多例句仍在对应专题中展开。
...
| which | 名词性成分，或修饰后面的名词 | 表有限范围中的选择。 |

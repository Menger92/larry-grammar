...
| 独立句类型 | 变成从句时的连接词 | 截图例句 |
| --- | --- | --- |
| 陈述句 | that | That Sally is beautiful is true. |
...
| 截图例句 | 变化重点 |
| --- | --- |
| What's your name? → I don't know what your name is. | 特殊疑问句进入从句后，用陈述语序。 |
| Why are you laughing? → I don't know why you are laughing. | why 保留在从句句首，后面是陈述语序。 |
| Where does Sally live? → I don't know where Sally lives. | 去掉助动词 does，谓语回到 lives。 |
...
| 抽象名词 | 同位语从句 | 例句 | 分析 |
| --- | --- | --- | --- |
| news | that they won the championship | The news that they won the championship spread quickly. | that they won... 解释 news 的具体内容。 |
| fact | that she lied | The fact that she lied disappointed everyone. | that she lied 解释 fact 的内容。 |
...
| 原疑问句 | 名词性从句 | 是否变更语序 | 分析 |
| --- | --- | --- | --- |
| What's your name? | I don't know what your name is. | 需要 | what 作表语，your name is 使用陈述语序。 |
| Why are you laughing? | I don't know why you are laughing. | 需要 | why 作原因状语，you are laughing 使用陈述语序。 |
| Where does Sally live? | I don't know where Sally lives. | 需要 | 去掉助动词 does，谓语回到 lives。 |
| When did Sally leave? | I don't know when Sally left. | 需要 | 去掉 did，谓语回到 left。 |
| When will Sally leave? | I don't know when Sally will leave. | 需要 | will 本身保留在主语 Sally 后面。 |
...
| 句首主语从句 | 形式主语改写 | 分析 |
| --- | --- | --- |
| That Sally is beautiful is true. | It is true that Sally is beautiful. | that 从句是真正主语；it 是形式主语。 |
...
| 位置 / 结构 | 推荐 | 不推荐或需谨慎 | 例句 |
| --- | --- | --- | --- |
| 介词后 | whether | if | I am unsure about whether we should go to the party. |
...
| --- | --- | --- | --- |
| that | 不作成分 | 陈述一件事 | 从句本身结构完整，that 只负责连接。 |
| whether / if | 不作成分 | 是否 | 表达不确定选择；whether 更正式。 |
| what | 作主语、宾语或表语 | 所……的事物 | 从句缺少名词性成分时常用 what。 |
| who / whom | 作主语或宾语 | 谁 / 谁作为对象 | who 作主语；whom 更正式，常作宾语。 |
| which | 作主语、宾语或定语 | 哪一个 | 在有限范围中选择。 |

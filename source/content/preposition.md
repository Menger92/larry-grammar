...
来源说明：本章例句优先使用用户截图中可见的 `up / on` 对比、介词后接名词性成分、介词短语作形容词性 / 副词性成分等内容；已确认例句登记在 `source/sources/evidence-log.md` 和 `source/sources/example-source-audit.md`。

## 本章结论卡

| 项目 | 结论 |
| --- | --- |
| 一句话本质 | 介词先和后面的名词性成分组成介词短语，再由整个短语进入句子承担功能。 |
| 核心公式 | `介词 + 名词性成分 = 介词短语` |
| 判断入口 | 先看介词后面有没有名词性成分，再看整个短语修饰谁。 |
...
1. 检查后面是否有名词性成分。
2. 有：按介词处理，并和后面的成分组成介词短语。
3. 没有：检查这个词是否在作副词或形容词。
4. 介词短语修饰名词时作形容词性成分；修饰动作、状态或整句时作副词性成分。

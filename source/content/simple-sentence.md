...
| --- | --- | --- | --- |
| 说明主语状态 | He is walking around naked. | He is walking around nakedly. | naked 说明 He 的状态，可理解为 [He is naked]；nakedly 变成修饰 walking around 的方式，语法形式可成立，但通常不是要表达的意思。 |
...
| 主系补 / 主系表 SVC/SVP | 主语 + 系动词 + 主语补语（传统表语） | Sally is beautiful.<br>He is a teacher. | 系动词后面的成分补充说明主语；beautiful 是形容词性主语补语，a teacher 是名词性主语补语。 |
...
SVOO 和 SVOC 的区分很重要：前者是两个宾语，后者是宾语后面跟一个补充说明宾语的成分。
